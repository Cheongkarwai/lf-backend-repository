...
public class FormRepository implements IFormRepository{
    ...
    @Override
    public CompletionStage<List<Form>> findAll(Stage.Session session, FormPageRequest pageRequest, List<FormId> formIds){
        ...
        predicates.add(root.get(Form_.FORM_ID).in(formIds));
        cq.select(root);
    ...
    @Override
    public CompletionStage<Long> countInIds(Stage.Session session, List<FormId> formIds){
        CriteriaBuilder criteriaBuilder = sessionFactory.getCriteriaBuilder();
        CriteriaQuery<Long> cq = criteriaBuilder.createQuery(Long.class);
        Root<Form> root = cq.from(Form.class);
        ...
        cq.select(criteriaBuilder.count(root));
        cq.where(root.get(Form_.FORM_ID).in(formIds));
    ...
    @Override
    public CompletionStage<Form> findById(Stage.Session session, FormId formId) {
    ...
    @Override
    public CompletionStage<List<Form>> findAllByIds(Stage.Session session, List<FormId> formIds) {
        return null;
    }
    ...
    @Override
    public CompletionStage<Void> deleteById(Stage.Session session, FormId formId) {
        return null;
    }

    @Override
    public Form loadReferenceById(Stage.Session session, FormId formId) {
        return null;
    }
    ...
    @Override
    public CompletionStage<Integer> deleteAllByIds(Stage.Session session, List<FormId> formIds) {
        return null;
    }
